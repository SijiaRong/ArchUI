...
### 基础风格描述（所有素材共用）
```
[在此填写：风格关键词，如 "modern, tech, minimalist, deep blue palette, geometric patterns"]
遵循 vi 模块定义的视觉语言
```
...
**Hero 图（主视觉）**
```
[项目核心隐喻的视觉表达] + [vi 风格关键词] + [构图要求：留白/对称/动感]
aspect ratio: 16:9, high resolution, no text
```

**图标组**
```
flat icon, [vi 主色], simple geometry, [功能含义], white background
